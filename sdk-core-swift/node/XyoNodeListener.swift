...
/// This protocal acts as an interface for listening onto nodes. All of its callback methods live
/// in the XyoOriginChainCreator class and can be added through the .addLsistener function.
