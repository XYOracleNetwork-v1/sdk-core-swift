...
class XyoObjectSchemaTest : XCTestCase {
    ...
    func testCreateCaseOne() {
        let schema = XyoObjectSchema.create(id: 0xff, isIterable: true, isTypedIterable: false, sizeIdentifier: XyoObjectSize.TWO)
    ...
    func testCreateCaseThree() {
        let schema = XyoObjectSchema.create(id: 0xff, isIterable: true, isTypedIterable: true, sizeIdentifier: XyoObjectSize.EIGHT)
    ...
    func testCreateCaseFour() {
        let schema = XyoObjectSchema.create(id: 0xff, isIterable: false, isTypedIterable: true, sizeIdentifier: XyoObjectSize.FOUR)
